...
export default function Sidebar({ role }: SidebarProps) {
    ...
    return (
        <aside className="w-64 bg-gray-900/80 backdrop-blur-xl border-r border-white/[0.06] min-h-screen p-6 flex flex-col">
            {/* Logo */}
            ...
            <nav className="space-y-2 flex-grow">
                    ...
                    if (isComingSoon || isLocked) {
                        return (
                            <button
                                ...
                                className="flex items-center gap-3 px-4 py-3 rounded-lg transition-all text-gray-500 hover:bg-white/5 w-full text-left relative group"
                            >
                                ...
                                <span className="ml-auto">
                                    {isLocked ? (
                                        ...
                                        <span className="px-2 py-0.5 text-[10px] bg-yellow-500/10 text-yellow-400 rounded-full font-semibold">
                                            Soon
                                        </span>
                                    )}
                                </span>
                ...
                ${isActive
                                    ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg shadow-indigo-500/20'
            ...
            {showComingSoonModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-gray-900 border border-white/10 rounded-2xl shadow-2xl max-w-md w-full p-8 relative animate-fade-in">
                        <button
                        ...
                        <div className="text-center">
                            ...
                            <button
                                onClick={() => setShowComingSoonModal(false)}
                                className="w-full px-6 py-3 bg-white/5 text-gray-300 rounded-lg font-medium hover:bg-white/10 transition-all"
                            >
                                Maybe Later
                            </button>
                        </div>
