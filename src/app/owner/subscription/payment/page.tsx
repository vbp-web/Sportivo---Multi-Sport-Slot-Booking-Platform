        ...
        <div className="min-h-screen bg-gray-950">
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-gray-900/60 rounded-lg shadow-lg p-6">
                        ...
                        <div className="mb-6 text-center">
                            ...
                            <p className="mt-3 text-sm text-gray-400">Scan this QR code to pay</p>
                        </div>
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                            ...
                            <div className="flex items-center justify-between bg-gray-900/60 rounded-lg px-4 py-3">
                                <span className="font-mono text-lg text-white">{adminSettings.upiId}</span>
                                <button
                                    onClick={() => {
