...
const categoryColors = {
    ...
    other: 'bg-white/[0.05] text-gray-100'
};
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                {features.length === 0 ? (
                    <div className="text-center py-12 bg-gray-900/60 rounded-lg shadow">
                        ...
                        <h3 className="mt-2 text-sm font-medium text-white">No features</h3>
                            ...
                            <div key={category}>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    {categoryFeatures.map((feature) => (
                                        <div key={feature._id} className="bg-gray-900/60 rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
