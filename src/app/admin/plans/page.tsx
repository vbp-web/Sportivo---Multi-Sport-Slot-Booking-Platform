        ...
        <div className="min-h-screen bg-gray-950">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                {plans.length === 0 ? (
                    <div className="text-center py-12 bg-gray-900/60 rounded-lg shadow">
                        ...
                        <h3 className="mt-2 text-sm font-medium text-white">No plans</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {plans.map((plan) => (
                            <div key={plan._id} className="bg-gray-900/60 rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
                                ...
                                <div className="mb-4">
                                    <div className="text-sm font-medium text-gray-300 mb-2">Limits:</div>
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 overflow-y-auto">
                    <div className="bg-gray-900/60 rounded-lg p-8 max-w-2xl w-full mx-4 my-8">
