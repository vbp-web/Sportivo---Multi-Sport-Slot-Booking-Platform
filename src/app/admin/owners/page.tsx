        ...
        return (
            <div className="min-h-screen bg-gray-950 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="mt-4 text-gray-400">Loading owners...</p>
                </div>
            </div>
        );
    }
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                {owners.length === 0 ? (
                    <div className="text-center py-12 bg-gray-900/60 rounded-lg shadow">
                        ...
                        <h3 className="mt-2 text-sm font-medium text-white">No {filter} owners</h3>
                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody className="bg-gray-900/60 divide-y divide-gray-200">
                                    {owners.map((owner) => (
                                        <tr key={owner._id} className="hover:bg-white/5">
                                            <td className="px-6 py-4">
                                                <div className="text-sm font-medium text-white">{owner.ownerName}</div>
                                                <div className="text-sm text-gray-500">
                                                    Registered: {new Date(owner.createdAt).toLocaleDateString()}
                                                </div>
                                            </td>
                                            <td className="px-6 py-4">
                                                <div className="text-sm font-medium text-white">{owner.venueName}</div>
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="text-sm text-white">{owner.userId.phone}</div>
                                                {owner.userId.email && (
