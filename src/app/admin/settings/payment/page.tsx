...
export default function AdminPaymentSettingsPage() {
    ...
    const [businessName, setBusinessName] = useState('Box Cricket Platform');
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Box Cricket Platform"
                                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            />
                            <p className="mt-1 text-sm text-gray-500">
                                This name will be shown to owners during payment
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            />
                            <p className="mt-1 text-sm text-gray-500">
                                Enter the platform UPI ID for receiving subscription payments
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-gray-500">
                                Upload the platform UPI QR code. Owners will scan this to pay for subscriptions.
                            </p>
                        </div>
                    ...
                    <div className="flex">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-yellow-800">
                                These payment details will be shown to all venue owners when they subscribe to plans.
                                Make sure the UPI ID and QR code are correct and belong to your business account.
                            </p>
                        </div>
                    </div>
                </div>
