                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {venues.map((venue) => (
                            <div
                                ...
                                className="bg-gray-900/60 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer"
                            >
                                ...
                                {venue.amenities && venue.amenities.length > 0 && (
                                    <div className="flex flex-wrap gap-2 mb-4">
                                        ...
                                        {venue.amenities.length > 3 && (
                                            <span className="px-2 py-1 bg-white/[0.05] text-gray-400 text-xs rounded-full">
